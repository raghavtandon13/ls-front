      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            <DollarSign className="h-6 w-6 text-primary animate-pulse-soft" />
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  Compare offers from 50+ lenders and apply with just one click.
                  No paperwork, no hassle.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto btn-hover-effect gradient-primary"
                  >
                ...
                <div className="flex items-center gap-4 pt-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    <span className="font-medium">4,000+</span> loans approved
                    this month
                  </p>
                </div>
              </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div
                className={`space-y-2 ${isLoaded ? "animate-fade-up" : "opacity-0"}`}
              >
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  We've simplified the loan process so you can focus on what
                  matters most.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              ...
              >
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Fill out just one simple form to access offers from 50+
                    lenders.
                  </p>
                </CardContent>
              </Card>
              ...
              >
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    See side-by-side comparisons of rates, terms, and fees in
                    seconds.
                  </p>
                </CardContent>
              </Card>
              ...
              >
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Apply for your chosen loan with a single click. No duplicate
                    paperwork.
                  </p>
                </CardContent>
              </Card>
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  Whether you're consolidating debt, renovating your home, or
                  covering unexpected expenses, we'll help you find the perfect
                  personal loan.
                </p>
              ...
              >
                ...
                <Card className="relative card-hover-effect">
                  ...
                  <CardFooter className="text-xs text-muted-foreground">
                    <p>
                      Example only. Your actual rate may vary based on credit
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              ...
              >
                ...
                <Card className="relative card-hover-effect">
                  ...
                  <CardFooter className="text-xs text-muted-foreground">
                    <p>
                      Example only. Your actual rate may vary based on business
              ...
              >
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  From startups to established enterprises, we connect
                  businesses of all sizes with the right funding solutions.
                </p>
                <ul className="grid gap-2">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-primary" />
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-start gap-6 py-12 md:grid-cols-3 md:gap-12">
              ...
              >
                ...
                <p className="text-muted-foreground">
                  Fill out our simple form with basic information about your
                  loan needs and financial situation.
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className="text-muted-foreground">
                  Review personalized loan offers from multiple lenders side by
                  side to find your best match.
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className="text-muted-foreground">
                  Apply with one click and receive your funds, often as quickly
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              >
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Join thousands of satisfied borrowers who found their perfect
                  loan
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              ...
              >
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    "I was able to consolidate all my credit card debt into one
                    affordable monthly payment. The process was incredibly easy
                    and I saved thousands in interest!"
                  </p>
                </CardContent>
                <CardFooter>
                  <div className="flex items-center gap-4">
              ...
              >
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    "As a small business owner, I needed capital quickly to take
                    advantage of a growth opportunity. LoanSparrow connected me
                    with the perfect lender in minutes!"
                  </p>
                </CardContent>
                <CardFooter>
                  <div className="flex items-center gap-4">
              ...
              >
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    "I was shocked at how much lower the interest rate was
                    compared to what my bank offered. The one-click application
                    saved me hours of paperwork and I got approved the same
                    day!"
                  </p>
                </CardContent>
                <CardFooter>
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="max-w-[600px] md:text-xl/relaxed">
                  Join thousands of satisfied customers who found better rates
                  and terms through our platform.
                </p>
                <ul className="grid gap-2">
                  <li className="flex items-center gap-2">
                  ...
                  <li className="flex items-center gap-2">
                    <DollarSign className="h-5 w-5 animate-pulse-soft" />
              ...
              <div
                className={`mx-auto lg:mx-0 ${isLoaded ? "animate-slide-in-right" : "opacity-0"}`}
              >
                <Card className="bg-background text-foreground card-hover-effect">
                  <CardHeader>
                    <CardTitle>Create Your Free Account</CardTitle>
                    <CardDescription>
                      No credit check required to see your offers
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
      ...
      <footer className="w-full border-t bg-background py-6 md:py-12">
        <div className="container px-4 md:px-6">
          <div className="grid gap-8 lg:grid-cols-5">
            <div className="lg:col-span-2">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Connecting borrowers with the perfect loan since 2015. We've
                helped over 500,000 customers find better rates and terms.
              </p>
          ...
          <div className="mt-8 border-t pt-8 text-center text-sm text-muted-foreground">
            <p>
              © {new Date().getFullYear()} LoanSparrow. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
